...
int main() {
    ...
    do {
        ...
        printf(" - moveright x,y+p: Move o retangulo cujo canto inferior esquerdo esta na posicao (x, y) para a direita por 'p' posicoes.\n\n");
        printf(" - moveleft x,y+p: Move o retangulo cujo canto inferior esquerdo esta na posicão (x, y) para a esquerda por 'p' posicoes.\n\n");
